...
(3, 1, '1', 'Beaches', 'Mountains'),
(3, 2, '1', 'Historic', 'Modern'),
(3, 3, '0', 'Adventurous', 'Family-friendly'),
(3, 4, '1', 'Traveling with a companion', 'Traveling alone'),
(3, 5, '0', 'Relaxing', 'Fast-paced');
